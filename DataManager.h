...
/*provide access to ui16_var5, define setter and getter*/
extern uint16_t ui16_var5;
#define DataManager_set_ui16_var5(x) { if ((x>= 2 )&&( x<= 50)){ ui16_var5 = x ; } }
#define DataManager_get_ui16_var5()(ui16_var5)
